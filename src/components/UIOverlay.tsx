...
import { Play, SkipBack, SkipForward, Pause, History } from "lucide-react";
    ...
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-end p-10 z-10 font-sans">
      ...
      {narrative && (
        <div className="absolute top-10 left-1/2 -translate-x-1/2 w-full max-w-2xl pointer-events-none">
          <div className="bg-phantasm-card/80 backdrop-blur-2xl border-l-[6px] border-phantasm-accent p-8 rounded-r-3xl shadow-2xl transform animate-in fade-in slide-in-from-top-12 duration-1000 relative overflow-hidden">
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none bg-[repeating-linear-gradient(transparent,transparent_2px,rgba(255,255,255,1)_3px,rgba(255,255,255,1)_3px)] bg-size-[100%_4px]" />
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-[10px] font-mono text-white/20 uppercase tracking-widest">
                Vector_ID: {vectorId.slice(1, 7).toUpperCase()}
              </div>
            </div>
      ...
      <div className="flex justify-between items-end gap-12">
        ...
        <div className="w-96 pointer-events-auto">
          <div className="bg-phantasm-card/80 backdrop-blur-2xl border border-white/5 rounded-3xl p-8 shadow-2xl max-h-87.5 flex flex-col relative overflow-hidden group">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-12 bg-linear-to-t from-phantasm-card to-transparent pointer-events-none" />
          </div>
        </div>
